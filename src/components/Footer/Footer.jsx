...
export default function Footer() {
  return (
    <footer
      ...
      style={{
        backgroundImage: `url('https://images.pexels.com/photos/33397053/pexels-photo-33397053.jpeg?cs=srgb&dl=pexels-kammeran-gonzalez-keola-3137381-33397053.jpg&fm=jpg')`,
      }}
    >
          ...
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <img
                ...
                className="h-50 w-50 rounded-full shadow-md" // Circular logo with shadow
                alt="App Logo"
              />
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                <li className="mb-4 text-black">
                  <a
                    href="https://github.com/abhisheksingh1204"
